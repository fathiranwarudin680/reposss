...
////< DAFTAR BUTTON BY follow @FathirAnwarudin > ////
...
tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI ZYY BOTZ`
ind = {
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
       ...
       menu =` _HAI SAYA ${botName}_
 
`

              
    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: `┈┈┈╱▔▔▔▔▔▔▔▔╲┈┈┈\n┈┈┈▏┈┈┈┈┈┈┈┈▕┈┈┈\n┈┈┈  ╭━╮┈┈╭━╮▕┈┈┈\n╱▔╲╲╰━╯╱╲╰━╯╱╱▔╲\n╲▂╲╲▏╮┈▔▔┈╭▕  ╲╲▂╱\n╱▔╲╲┣╋╋╋╋┫  ╲╲╲\n╲▂╱┈╲▂▂▂▂▂▂╱┈╲▂╱\n----------------\n🇮🇩𝘽𝙊𝙏 𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝙏𝙄𝙊𝙉\n🇮🇩 ${prefix} 𝙎𝙋𝙀𝙀𝘿 : *${latensie.toFixed(4)} _Second_*\n🇮🇩 ${prefix} 𝘼𝘾𝙏𝙄𝙑𝙀 : *${runtime(process.uptime())}*\n🇮🇩 ${prefix} 𝙋𝙇𝘼𝙏𝙁𝙍𝙊𝙈 : *${os.platform()}*\n🇮🇩 ${prefix} 𝙏𝙊𝙏𝘼𝙇: *${_registered.length}* *User*\n🇮🇩 ${prefix} 𝙋𝙍𝙀𝙁𝙄𝙓: ${prefix}\n🇮🇩 𝙔𝙊𝙐𝙍 𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝙏𝙄𝙊𝙉\n🇮🇩 ${prefix} 𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀: *${pushname}*\n🇮🇩 ${prefix} 𝙎𝙀𝙉𝘿𝙀𝙍 : *@${sender.split('@')[0]}*\n🇮🇩 ${prefix} 𝘽𝙄𝙊 𝙄𝙉𝙁𝙊 : *${thu.status}*\n🇮🇩 ${prefix} 𝙋𝙍𝙀𝙈𝙄𝙐𝙈 : *${isPremium ? 'Ya' : 'No'}*\n🇮🇩 ${prefix} 𝘼𝘿𝙈𝙄𝙉 : *${isGroupAdmins ? 'Ya' : 'No'}*\n🇮🇩 ${prefix} 𝙇𝙀𝙑𝙀𝙇 : *${Levelnye}*\n🇮🇩 ${prefix} 𝙓𝙋 : *${Xpluu} / ${requiredXplu}*\nFlw: instagram.com/zyystore_
📅 Day : ${week} ${weton}\n📅 Date : ${date}\nYANG MAU CARI JODOH KETIK !start\nPREFIX BOT !`,buttons: [{ buttonId: noprefix ? "command" : "!"+"command", buttonText: { displayText: 'LIST MESSAGE' }, type: 1 },{ buttonId: noprefix ? "sewabot" : "!"+"sewabot", buttonText: { displayText: 'SEWA BOT' }, type: 1 },{ buttonId: noprefix ? "menu" : "!"+"botanon", buttonText: { displayText: 'ANON BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
              case "botanon":
              tutor2 = 
`*ANONYMOUS BOT BETA*
...
▹ ${prefix} wallgravity text1 text2
 `
sendButMessage(from, wibu, `created follow @FathirAnwarudin`, [
          {
...
`
   sendButMessage(from, wibu, `created follow @FathirAnwarudin`, [
        ...
        case 'simi':
              ...
              buttonsMessage = {footerText:'follow @FathirAnwarudin', imageMessage: imageMsg,
...
▹ ${prefix} bokep25
 `
               ...
               sendButMessage(from, menu, `created follow @FathirAnwarudin`, [
          {
            buttonId: noprefix ? "menu" : "!"+"menu",
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
*「 Iky Botz 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Terdaftar Di Zyy Botz *`)
		}, 2000)
        break
case 'sfire1':{
...
┏━━⬣ MINAT? PM
┃⬡ wa.me/6281383591303
┃⬡ Ig https://instagram.com/zyystore_
┃⬡ Yt https://youtube.com/channel/UCdWYt4sTS5IA-BJszuYVqWQ
┗━━⬣
`
...
Wa.me/6283141727903`
   sendButMessage(from, titid, `follow @FathirAnwarudin `, [
          {
...
"productId": "4120139628109348"
  ...
  case 'scan':
    ...
    "listMessage": {
      ...
      "footerText": "\nPowered follow @FathirAnwarudin.                                        "
    }
  }, {quoted:kyy})
  ikyy.relayWAMessage(list, {waitForAck: true})
  break
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              ikyy.sendMessage('6281383591303@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
