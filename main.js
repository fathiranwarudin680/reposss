...
const starts = async (ikyy = new WAConnection()) => {
	...
	ikyy.browserDescription = ["ZYY - BOT", "Chrome", "3.0.0"];
	...
	ikyy.on('connecting', () => {
		...
		console.log(color('[ FATHIR GANS ]', 'cyan'), color('Menghubungkan....'));
	...
	ikyy.on('open', () => {
		...
		console.log(color('[ FATHIR GANS ]', 'cyan'), color('Bot Sudah Online!'));
